...
public class CustomerController {
	...
	public ResponseEntity<?> findByFirstAndLastName(@RequestParam(value ="firstOrLastName")String firstOrLastName){
	 List<Customer> customer=customerService.findByRandomSearchTerm(firstOrLastName);
		if(customer==null)
			return new ResponseEntity<>(HttpStatus.NOT_FOUND);
		return new ResponseEntity<>(customer, HttpStatus.OK);
	}
	...
	public ResponseEntity<?> addCustomer(@RequestBody Customer customer) {
		...
		String message="Unable to create Customer. Mobile number already present";
		Customer newCustomer=customerService.findByMobileNumber(customer.getMobileNumber());
